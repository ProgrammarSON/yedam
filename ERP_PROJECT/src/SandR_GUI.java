...
public class SandR_GUI extends JFrame {
	...
	public SandR_GUI() {
		...
		pkey_label = new JLabel("product_name");
		pkey_label.setBounds(111, 10, 87, 32);
		contentPane.add(pkey_label);
		
		amount_label = new JLabel("stock");
		amount_label.setBounds(210, 10, 87, 32);
